package mx.tecnm.cdhidalgo.smarthome
...
class MyAdapter(private val datos: Array<Array<String?>>, private val myListener: MyListener):
    ...
    inner class ViewHolder(itemSensor: View): RecyclerView.ViewHolder(itemSensor) {
        ...
        lateinit var bDelete: ImageView
        init {
            ...
            bDelete = itemSensor.findViewById(R.id.bDelete)
            bEdit.setOnClickListener { myListener.onClickEdit(adapterPosition) }
            bDelete.setOnClickListener { myListener.onClickDel(adapterPosition) }
        }
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val itemSensor: View =  LayoutInflater.from(parent.context).inflate(R.layout.item_sensor, parent, false)
